...
PopupWindow {
    ...
    component MenuEntry: RippleButton {
        ...
        opacity: menuEntry.enabled || menuEntry.isSeparator ? 1 : 0.58
        Layout.fillWidth: true
        Layout.topMargin: menuEntry.isSeparator ? 5 : 0
        Layout.bottomMargin: menuEntry.isSeparator ? 5 : 0
        ...
        contentItem: RowLayout {
            ...
            spacing: 10
            visible: !entryButton.menuEntry.isSeparator
