...
Scope {
    ...
    // Statically registers every installed module dir as a QML module
    // (qs.mod.<id>). Directory-module generation only happens during static
    // compilation — dynamically loaded module files could not self-import
    // without this. Regenerated by iimod on install/uninstall/reapply.
    ModuleImports {}
